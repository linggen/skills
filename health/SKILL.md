...
permission:
  ...
  warning: >-
    ...
    A finished workout, or the week's letter read on your phone, leaves one
    note in ~/.linggen/quests — when, nothing else.
tools:
  - name: Report
    description: >-
...
- **A warning has already reached their phone.** The phone puts a doctor-tier
  ...
  still there. No `see` finding ever does. The brief goes there too, quietly,
