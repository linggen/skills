...
**首领牌 — 传说即动词 (2026-09-25)**：十章的首领收服之后，牌各带它的传说，不再是
七张一样的 5 费 4/6 护主。夫诸 3 费 2/2 入阵水漫（它阵前各 1）· 狍鸮 4 费 3/3 入阵咬 2 ·
雷神 6 费 4/5 入阵雷（各 2）· 夔 5 费 4/6 护主，入阵鼓（它下回合灵力 −1）· 无支祁 5 费 5/5
入阵**锁**一个（它下回合不能出手）· 防风氏 5 费 3/8 护主 · 巴蛇 5 费 4/5 入阵**吞**一个攻 ≤3 的 ·
夔牛 5 费 4/4 入阵全体 +1/+1 · 肥遗 4 费 3/4 **大旱**（站着时，你每回合末它阵前各 1）·
泰逢 5 费 4/5 入阵抽 2。新动词四个（battle.js EFFECTS：chain · swallow · drain · drought），
妖打出来一样灵：锁你最能打的，吞够得着的。锁与吞必须指它阵前的一个，吞指大了按名拒（吞不下）。
闸 § 首领牌：每张换进五副原型，−0.4 到 +5.3 点，越过 12 点报越界。
