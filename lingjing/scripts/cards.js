...
export const WORDS = {
  zh: {
    ...
    questTitle: '月下之约', questSteps: { bell: '先寻一只银月铃。', water: '带铃到有水照月处。', ring: '此处水面有月——摇铃。', riddle: '她在等你答。' }, ring: '摇一摇铃', sayRing: '摇一摇铃',
  ...
  en: {
    ...
    questTitle: 'The promise under the moon', questSteps: { bell: 'Find a silver-moon bell.', water: 'Carry it to water that holds a moon.', ring: 'There is a moon on this water — ring it.', riddle: 'She is waiting for your answer.' }, ring: 'Ring the bell', sayRing: 'Ring the bell',
