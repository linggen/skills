...
export const WORDS = {
  zh: {
    ...
    choreOpen: '去 {app} 做', about: '问询', askHint: '想问什么？留空，便请她说说', askSend: '问', drop: '撂 下', paysWord: '酬', nextWord: '其后', feed: '喂它{item}', offer: '献上{item}', sayOffer: '向{name}献上{item}', feedNone: '囊中没有{item}', tameHint: '降了它，再献上{item}，即可收服', featRise: '突破', featChapter: '新章', wonOver: '收服', subdue: '降妖',
